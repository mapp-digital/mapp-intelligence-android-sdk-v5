...
internal val trackRequests = listOf(
    TrackRequest(name = "page 1").apply { this.id = 1 },
    TrackRequest(name = "page 2").apply { this.id = 2 },
    TrackRequest(name = "page 3").apply { this.id = 3 },
    TrackRequest(name = "page 4").apply { this.id = 4 }
)
